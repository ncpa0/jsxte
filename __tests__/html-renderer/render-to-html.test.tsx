...
const allTests =
  ...
  () => {
    ...
    it("should correctly parse html with and without whitespace", () => {
      const App = () => {
        return (
          <div>
            <span>
              <span>Foo</span> <span>Bar</span> <span>These should have whitespace between</span>
            </span>
            <br />
            <span>
              <span>Foo</span>
            ...
            <br />
            <span>
              - <span>should have a space between the "-" and the tag (not a new line)</span>
            </span>
            <br />
            <span>
              -<span>should have no space between the "-" and the tag</span>
            </span>
            <br />
            <span>
              [
    ...
    it("should correctly handle nulls, undefined and boolean values", () => {
      ...
      const renderedDivWithUndefined = renderToHtml(<DivWithUndefined />, renderOpts);
